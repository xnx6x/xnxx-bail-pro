    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (messageType) {
                switch (messageType) {
                    case 'PAYMENT':
                        return await nexus.handlePayment(content, jid, quoted)
                    
                    case 'PRODUCT':
                        return await nexus.handleProduct(content, jid, quoted)
                    
                    case 'INTERACTIVE':
                        return await nexus.handleInteractive(content, jid, quoted)

                    case 'ALBUM':
                        return await nexus.handleAlbum(content, jid, quoted)
                    ...
                    case 'STICKER_PACK':
                        return await nexus.handleStickerPack(content.stickerPack, jid, quoted)
